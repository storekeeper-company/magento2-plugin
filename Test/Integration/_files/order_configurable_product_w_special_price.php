...
$orderConfigurableItem->setPrice(50.00);
$orderConfigurableItem->setPriceInclTax(60.50);
$orderConfigurableItem->setOriginalPrice(100.00);
$orderConfigurableItem->setTaxPercent(21.00);
$orderConfigurableItem->setTaxAmount(10.50);
